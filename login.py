...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.u_name_label.setGeometry(QRect(150, 110, 90, 20))
        font = QFont()
        ...
        self.pass_label.setGeometry(QRect(150, 150, 90, 21))
        font = QFont()
        font.setPointSize(10)
        ...
        self.uname_lineEdit.setGeometry(QRect(250, 110, 100, 20))
        self.uname_lineEdit.setObjectName("uname_lineEdit")
        self.pass_lineEdit = QLineEdit(Dialog)
        self.pass_lineEdit.setGeometry(QRect(250, 150, 100, 20))
