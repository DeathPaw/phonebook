...
class Ui_signUp(object):
    def setupUi(self, Dialog):
        ...
        self.label_2.setGeometry(QRect(160, 280, 81, 31))
        font = QFont()
        font.setPointSize(10)
        ...
        self.label_5.setGeometry(QRect(160, 230, 81, 31))
        font = QFont()
        font.setPointSize(10)
        ...
        self.birthsday_lineEdit = QLineEdit(Dialog)
        self.birthsday_lineEdit.setGeometry(QRect(250, 230, 141, 20))
        self.birthsday_lineEdit.setObjectName("birthsday_lineEdit")


        self.password_lineEdit = QLineEdit(Dialog)
        self.password_lineEdit.setGeometry(QRect(250, 280, 141, 20))
        self.password_lineEdit.setObjectName("password_lineEdit")
        self.signup_btn = QPushButton(Dialog)
        self.signup_btn.setGeometry(QRect(270, 330, 75, 23))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_5.setText(_translate("Dialog", "BIRTHSDAY"))
...
class Dialog(QDialog, Ui_signUp):
    ...
    def insertData(self):
        ...
        birthsday = self.birthsday_lineEdit.text()
        ...
        result = self.parent.loginDatabase.conn.execute("SELECT * FROM MYUSERS WHERE USERNAME = ?", (username,))
        if result.fetchall():
            msg = QMessageBox.information(self, 'Внимание!', 'Пользоватеть с таким именем уже зарегистрирован.')
        else:
            self.parent.loginDatabase.conn.execute("INSERT INTO MYUSERS VALUES(?, ?, ?, ?)",
                                                   (username, email, birthsday, password))
